...
This is my actual domain - thanks to a sweet project called [Handshake][hns], I own the top level domain `mandelliant/`. If you're [resolving HNS domains][hns-sites], check out [writtenby.mandelliant/](writtenby.mandelliant/). I plan to write more about Handshake and setting up the domain soon.
